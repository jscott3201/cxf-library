...
source:
  - "HVAC FDD Reference v1.0 §9, AHU-FC-059"
...
![AHU-FC-059 block graph](diagram.svg)
...
valve position; judging coil operation inside that band is AHU-FC-050's job, not
...
- Preconditions (fan running, OAT trustworthy) are declared in frontmatter for
  host enforcement rather than encoded in the block graph, as in AHU-FC-050.
