...
Hydronic pump fault detection rules (`PMP-FC-*`). Source grounding: HVAC FDD
...
|---|---|---|---|---|
| PMP-FC-050 | Pump commanded on, no flow detected | 2 | rule | **verified** |
| PMP-FC-051 | Pump deadheading (high DP, low/no flow) | 2 | rule | **verified** |
...
- **PMP-FC-050 vs -051** differ in what they can see: -050 needs only
...
- **VFD-FC-050/051** watch the same drive from the electrical side; a
