...
3. Condenser or evaporator coil fouling — the pathology RTU-FC-051 detects from
...
- **`method: statistical` describes the baseline's provenance, not the runtime.**
  ...
  classification is recorded rather than relabelled; RTU-FC-051 carries the same
  note.
