...
source:
  - "HVAC FDD Reference v1.0 §9, AHU-0023"
...
rule and its twin AHU-0024 are the "74% problem," the trigger pair for
...
![AHU-0023 block graph](diagram.svg)
...
Fastest payback in the catalog together with AHU-0024: remote fix ~90%,
