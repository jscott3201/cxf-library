# Playbook: ERV Effectiveness Degradation
...
2. For enthalpy wheel units, check that the wheel is spinning — a failed drive
   motor or belt leaves the wheel stationary, providing almost no energy
   recovery. Check belt tension and motor amperage.
...
1. After service, recalculate effectiveness.
2. Target: effectiveness returns to within 15% of the commissioning or rated
   value.
