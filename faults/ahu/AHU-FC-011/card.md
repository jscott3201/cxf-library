...
AHU-FC-051 catches a damper that stays shut when outdoor air is useful,
AHU-FC-009 an economizer still modulating after outdoor air stopped being
...
reverse of AHU-FC-009's, because the two rules look at opposite ends of the
...
data can substitute the direct measurement AHU-FC-051 uses. Cooling-dominant,
...
- **Operating-state gating and NO_EVAL are frontmatter, not graph.** G36 scopes
  ...
  (precedent AHU-FC-063). A host that evaluates in OS#2 will see this rule
...
global OAT sensor recomputes both — 5.0 °C here, 3.0 °C for AHU-FC-009 — and
