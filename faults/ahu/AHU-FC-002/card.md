...
AHU-FC-003 is its mirror on the high side; both sit in cluster CLU-09 (Sensor
...
bounds reads high — which is why the diagnoses mirror AHU-FC-003's rather than
...
onto the sensor. AHU-FC-062 runs a 15-minute delay against this pair's 30, so
